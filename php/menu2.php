...
<!--below rightMenu-->
	...
	<!--MenuContainer 部分-->
	    <div id="menucontainer">
		    <div id="se2">
			    <div>
					...
					<form method="post" id="searchInput" action="../search/search.php">
						<p>
						<input type="text" id="sInput" name="search" title="站内搜索" placeholder="请输入关键词">
						<div onmouseover="Mover2()" onmouseout="Mout2()">
							<input type="image" id="searchSubmit" name="submit" src="../img/searchButton.png" title="搜索">
						</div>
						</p>
					</form>
		    ...
		    <div id="sets2">
			    <div id="chgimg">
					...
					<div onmouseover="Mover()" onmouseout="Mout()">				
						<a>
						   <img src="../img/cancel.png" id="settingCancel" onClick="Cancel5()" style="border:0px" title="完成并退出">	
						</a>
					</div>			
				</div>
        ...
        <div id="clicktohide" style="position:absolute;z-index:-4;width:80%;height:100%;opacity:0" onclick="clickToHide()"></div><!--隐藏的图片，点击右侧menu之后浮出，点击其上则菜单消失-->
