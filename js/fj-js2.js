...
/*以上和主页色块拖动（Draggable）相关代码*/
	...
	if ( browser=="Microsoft Internet Explorer"){
		alert("提示：为保证浏览效果建议您使用Firefox或Chrome浏览器浏览本网页！");
...
/*以下右侧menuClick动作（鼠标点击弹出或跳转）*/
	...
	document.getElementById("clicktohide").style.zIndex ="4";//透明图片弹出
	}
    function Cancel()
	{
	document.getElementById('se2').style.display ="none"
	document.getElementById("clicktohide").style.zIndex ="-4";//透明图片消失
	document.getElementById("rm").style.zIndex ="-4";//nav消失
	}
	...
	function Mover(){
	document.getElementById('settingCancel').src ="../img/scancelhover.png" 
	document.getElementById('searchCancel').src ="../img/scancelhover.png" 
	}	
	function Mout(){
	document.getElementById('settingCancel').src ="../img/scancel.png"
	...
	document.getElementById("sets2").style.display ="none";
	document.getElementById("se2").style.display ="none";/*隐藏弹出的搜索或改色*/
	document.getElementById("clicktohide").style.zIndex ="-4";//自己也消失
...
/*以上右侧menuClick动作（鼠标点击弹出或跳转）*/
	...
	function chg(col){
	document.getElementById("beijingse").style.background = col;/*背景色*/
	document.getElementById("bgpic").src = "" ;/*改变背景色的同时去掉背景图*/
	}
...
function EditFloat(){
	document.getElementById("floatedit").style.zIndex ="8";
	document.getElementById("floatedit").style.display ="block";
    }
function CancelEdit(){
	document.getElementById("floatedit").style.zIndex ="-8";
	}
...
function floatuserinfomenu(){
    ...
    document.getElementById("userinfomenu").style.zIndex ="8";
    }
